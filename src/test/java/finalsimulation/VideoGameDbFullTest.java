...
import io.gatling.recorder.internal.bouncycastle.crypto.generators.KDFDoublePipelineIterationBytesGenerator;
...
public class VideoGameDbFullTest extends Simulation {
        ...
        public void before() {
                ...
                System.out.printf("Ramping users over %d second%n", RAMP_DURATION);
                ...
                feed(jsonFeeder)
                        .exec(http("Create new game - #{name}")
                                ...
                                .header("Authorization","Bearer #{jwtToken}")
                                        .body(StringBody("bodies/newGameTemplate.json")).asJson()
                                );
